...
{
    [Serializable]
    public class RefuseViewProposal : ReplyData, ISerializable
    {
        public ServerData ServerData { get; }
        public View ServerView { get; }

        public RefuseViewProposal(ServerData server, View view) : base(-3)
        {
            ServerData = server;
            ServerView = view;
        }

        public RefuseViewProposal(SerializationInfo info, StreamingContext context) : base(info, context)
        {
