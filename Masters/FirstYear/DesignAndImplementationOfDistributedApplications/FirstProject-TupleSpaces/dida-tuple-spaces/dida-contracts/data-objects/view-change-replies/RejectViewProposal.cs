...
{
    [Serializable]
    public class RejectViewProposal : ReplyData, ISerializable
    {
        public ServerData ServerData { get; }
        public View ServerView { get; }

        public RejectViewProposal(ServerData server, View view) : base(-2)
        {
            ServerData = server;
            ServerView = view;
        }

        public RejectViewProposal(SerializationInfo info, StreamingContext context) : base(info, context)
        {
